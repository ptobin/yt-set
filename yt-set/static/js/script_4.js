$(function(){
	$('button').click(function(){
		...
		var scenePro = new SceneProcessor(partnerName, fileName, sceneArray);
	    var segmentForPython = scenePro.getSegmentsForFFMPEG();
		var segmentForLibAV = scenePro.getSegmentsForLibAV();
		var referenceExclusions = scenePro.getReferenceExclusions()
		
		var dataToSend = new Object();
		dataToSend.exclusions = referenceExclusions;
		dataToSend.pythonSegments = segmentForPython;
		dataToSend.segmentForLibAB = segmentForLibAV;
		dataToSend.fileName = $('#txtFileName').val();
		dataToSend.partnerName = partnerName;
